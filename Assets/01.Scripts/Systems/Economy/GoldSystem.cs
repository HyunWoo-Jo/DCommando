...
namespace Game.Systems {
    public class GoldSystem : IDisposable {
        ...
        public void Initialize() {
            ...
            EventBus.Subscribe<GoldRewardEvent>(OnGoldReward).AddTo(_disposables);
        }
        ...
        #endregion
        private void OnGoldReward(GoldRewardEvent grEvent) {
            AddGold(grEvent.amount);
        }
